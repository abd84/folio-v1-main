      ...
      <div className="mx-auto flex w-[90%] flex-col items-center justify-center lg:max-w-[1212.8px]">
        ...
        <div className="grid w-full grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="flex flex-col items-center rounded-lg bg-[#1a1d24]/80 p-8 text-center transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/10">
            ...
            <p className="text-sm text-[#e4ded7]/80">
              Founder of CodeTechMentor, a platform offering free resources and guidance in programming, data science, and AI. 
              Serving as a Teaching Assistant at FAST-NUCES, mentoring over 150 students in data science and applied machine 
              learning techniques.
            </p>
          </div>
        </div>
...
<div className="mt-20 w-full">
  ...
  <div className="flex flex-wrap gap-4">
    ...
    <span className="bg-[#1a1d24] text-[#e4ded7] py-2 px-4 rounded-full text-base">Zapier</span>
       ...
       {/* Languages Section */}
          <div className="mt-12 grid grid-cols-10 gap-3">
            <h3 className="col-span-10 text-2xl font-bold text-[#e4ded7]">
              Programming Languages
            </h3>
            <div className="flex items-center justify-center rounded-full bg-blue-500/20 p-2 text-xs font-medium text-blue-400">Python</div>
            <div className="flex items-center justify-center rounded-full bg-green-500/20 p-2 text-xs font-medium text-green-400">C++</div>
            <div className="flex items-center justify-center rounded-full bg-purple-500/20 p-2 text-xs font-medium text-purple-400">JavaScript</div>
            <div className="flex items-center justify-center rounded-full bg-yellow-500/20 p-2 text-xs font-medium text-yellow-400">SQL</div>
            <div className="flex items-center justify-center rounded-full bg-red-500/20 p-2 text-xs font-medium text-red-400">HTML/CSS</div>
            <div className="flex items-center justify-center rounded-full bg-gray-500/20 p-2 text-xs font-medium text-gray-400">React</div>
        ...
        <div className="mt-20 flex w-full flex-col items-center justify-center">
          ...
          <div className="grid w-full grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-5">
            {certifications.map((cert, index) => (
              <div
                key={index}
                className="group flex transform flex-col justify-center rounded-lg bg-[#1a1d24] p-5 text-center transition-all duration-300 hover:-translate-y-2 hover:shadow-lg hover:shadow-blue-500/10"
              >
                <h4 className="text-md font-bold text-[#e4ded7] transition-colors duration-300 group-hover:text-blue-400">
