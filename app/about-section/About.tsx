    ...
    <div className="mx-auto flex w-[100%] flex-col lg:max-w-[1200px] lg:flex-row lg:gap-20">
      ...
      <div className="mb-10 flex w-[100%] flex-col gap-4 text-base font-medium leading-relaxed tracking-wide text-[#e4ded7] md:mb-16 md:gap-6 md:text-lg lg:mb-16 lg:max-w-[90%]">
        <p>
         ...
         I have had the opportunity to work with many national and international clients, helping them solve their business problems by delivering AI solutions. Whether it’s building machine learning models, creating custom chatbots, or implementing AI automation workflows, I’ve worked on over 20 projects that have helped businesses improve their processes and grow.
